...
struct MacroState *macro_state_new(void);

void macro_state_free(struct MacroState *ptr);

void macro_init_operator(struct MacroState *runtime_state,
                         int32_t operator_id,
                         int32_t parallel_worker_number,
                         int32_t plan_type,
                         double optimizer_startup_cost,
...
const uint8_t *macro_operator_hash(const char *query_template, struct MacroState *macro_state);
